"""
AIS WebSocket → REST Bridge (v4 - Southeast Asia)
...
async def listen_ais():
    ...
    subscribe_message = {
        "APIKey": API_KEY,
        "BoundingBoxes": [
            [[-10, 95], [25, 141]]   # Southeast Asia: Indonesia, Malaysia, Singapore, Philippines, Vietnam, Thailand
        ],
        "FilterMessageTypes": [
            "PositionReport",
            "ShipStaticData",
    ...
    print("🌏 Starting Southeast Asia AIS connection...")
    ...
    while True:
        try:
            ...
            async with websockets.connect(
                ...
                print("📡 Subscribed — receiving Southeast Asia AIS stream...")
